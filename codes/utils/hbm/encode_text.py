...
# os.makedirs(args['text_data_dir'],exist_ok=True)
...
def encode_roberta_hbm(dataset_name):
    ...
    # Load pre-trained model (weights)
    model = RobertaModel.from_pretrained(pretrain_model)
...
if __name__ == "__main__":
    ...
    parser.add_option('-t', '--encoding_method', type='string', action='callback',dest='encoding_method',callback=list_callback, default=['roberta'])#传入一堆处理方法
