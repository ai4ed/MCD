...
class AreaAttention(nn.Module):
    ...
    def forward(self, q, k, v,return_details=False):
        """
        ...
        # print(f"v_area shape is {v_area.shape}")
        if return_details:
            details = {"weights":weights,"v_area":v_area,"logits":logits}
            return torch.matmul(weights, v_area),details
        else:
